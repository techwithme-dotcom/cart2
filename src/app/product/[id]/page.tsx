...
// ✅ generateMetadata does NOT use Promise for params
...
export default async function ProductPage({ params,
  ...
  params: Promise<RouteParams>; // <-- await needed
}) {
  const { id } = await params; // <-- important: await here
...
// // const ProductRatings = dynamic(() => import("@/components/ProductRatings"), { ssr: false });
...
//   const data = (allProducts as any[]).find((p) => p.md5_id === id);
